  ...
  return (
    <main className="container mx-auto prose prose-lg p-4 text-black marker:text-black break-words">
      ...
      <div className="bg-red-400 border-4 border-dashed border-slate-900 p-4 font-mono">
        ...
        /> : null}
        {code ?
        <Markdown className="bg-slate-200 px-4 border-4 border-solid border-slate-900" remarkPlugins={[remarkGfm, remarkMath]} rehypePlugins={[rehypeKatex]}>{code}</Markdown>
        : null}
      </div>
    </main>
  )
