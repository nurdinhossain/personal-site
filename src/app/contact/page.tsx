    ...
    return (
        <div>
            ...
            <main className="flex flex-row justify-center">
                <form name="ContactForm" className="flex flex-col bg-cyan-300 border-4 border-dashed border-slate-900 space-y-10 w-5/12 m-5 p-4" onSubmit={handleSubmit((data) => setData(JSON.stringify(data)))} data-netlify="true">
